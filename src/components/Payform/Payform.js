...
const Payform = ({
    ...
    return (
     <section className='container__component payForm' aria-label='Pay form section'>
        <AppleButton  
            text = 'Pay'
            icon={AppleIcon}
            iconPresence={true}
            iconStyles={{width: '1.8rem', height: '1.8rem'}} 
            className='btn__appleButton'
            type='submit'
        />      
          ...
          <div className='form__inputWrapper '>    
            <label>Card data</label>
              <div className='inputGroup'>
                ...
                <div className='inputGroup__errorMsgPos'>
